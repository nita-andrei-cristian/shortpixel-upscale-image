...
elseif (false === $has_data): 
	...
	if (false === $keyControl->keyIsVerified() && false === $has_data):
  		...
  		_e('Invalid API Key. <a href="options-general.php?page=shortpixel-upscale-settings">Check your Settings</a>','shortpixel-image-optimiser');
...
?>
	...
	<a class='button button-secondary' title="<?php _e('Restores the previous image SEO data, if available.', 'shortpixel-image-optimiser'); ?>" href="javascript:window.SPUIProcessor.screen.UndoAlt(<?php echo $item_id ?>, 'undo')"><?php _e('Undo', 'shortpixel-image-optimiser'); ?></a>

	<?php if (true === $isDifferent): ?>

	<a class='button button-secondary' title="<?php _e('Redo', 'shortpixel-image-optimiser'); ?>" href="javascript:window.SPUIProcessor.screen.UndoAlt(<?php echo $item_id ?>, 'redo')"><?php _e('Redo', 'shortpixel-image-optimiser'); ?></a>
	<?php endif; ?>
