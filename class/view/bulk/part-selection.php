					...
					<div class='thumbnails optiongroup'>
						<div class='switch_button'>
							...
							<div class='option'>
								...
								<span class="number" ><?php echo esc_html($approx->media->thumbs) ?> </span>
							</div>
			 ...
			 <div class='ai-images optiongroup'>
				...
				<label>
				 ...
				 <h4><label for="autoai_checkbox">
					<?php printf(esc_html__('Use ShortPixel AI to generate image SEO data for all Media Library images, according to the %ssettings%s', 'shortpixel-image-optimiser'), '<a href="options-general.php?page=shortpixel-upscale-settings&part=ai">', '</a>' ); ?>
				...
				<label>
				 ...
				 <h4><label for="aipreserve_checkbox">
					<?php printf(esc_html__('Prevent overriding any of the existing data with the one generated by AI', 'shortpixel-image-optimiser'), '<a href="options-general.php?page=shortpixel-upscale-settings&part=ai">', '</a>' ); ?>
              				<span class='new'><?php _e('New!', 'shortpixel-image-optimiser'); ?></span>
				 </label></h4>
