...
<!--
  <div class='top-buttons'>
    <button><i class='shortpixel-icon notifications'></i><?php esc_html_e('Notifications','shortpixel-upscale-image'); ?></button>
...
<div class="shortpixel-bulk-wrapper">
  ...
  <div id="processPaused" class="processor-paused" data-action="ResumeBulk"><span class='dashicons dashicons-controls-pause' data-action="ResumeBulk"></span>
    <?php if (true === \wpSPUI()->settings()->doBackgroundProcess)
    {
        ...
        $spui_alt = esc_html__( 'Click here to continue processing in this browser, which may be faster', 'shortpixel-upscale-image' );
    }
    else {
    ...
    <p class='small'><?php echo esc_html( $spui_alt ); ?></p>
  </div>
