...
<section id="tab-ai" class="<?php echo ($this->display_part == 'ai') ? 'active setting-tab' : 'setting-tab'; ?>" data-part="ai">
  ...
  <settinglist>
    ...
    <h2><?php esc_html_e('AI Image SEO & Accessibility', 'shortpixel-upscale-image'); ?></h2>
      ...
      <content>
        ...
        <?php $this->printSwitchButton(
          [
            ...
            'label' => esc_html__('Enable AI Image SEO', 'shortpixel-upscale-image'),
        ...
        <name>
          ...
          <?php esc_html_e('Show AI image SEO options throughout ShortPixel Image Upscaler. The generated ALT tag is also very useful for accessibility.', 'shortpixel-upscale-image'); ?>
      ...
      <content>
        ...
        <?php $this->printSwitchButton(
          [
            ...
            'label' => esc_html__('Generate image SEO data on upload', 'shortpixel-upscale-image'),
          ]
        );
        ?>
        ...
        <name>
          ...
          <?php esc_html_e('Automatically generate image SEO data with AI after uploading the image, based on the settings below.', 'shortpixel-upscale-image'); ?>
      ...
      <content>
        ...
        <?php $this->printSwitchButton(
          [
            ...
            'label' => esc_html__('Generate image SEO data during Bulk Processing', 'shortpixel-upscale-image'),
          ]
        );
        ?>
        ...
        <name>
          ...
          <?php esc_html_e('Automatically generate image SEO data using AI for all the images queued during the Bulk Processing. The settings below will be taken into account when running the bulk.', 'shortpixel-upscale-image'); ?>
      ...
      <content>
        ...
        <?php $this->printSwitchButton(
          [
            ...
            'label' => esc_html__('Preserve existing Image SEO data', 'shortpixel-upscale-image'),
        ...
        <name>
          ...
          <?php esc_html_e('When enabled, all existing ALT tags, captions and descriptions are retained. Disabling the switch means that the SEO data for images created with AI will overwrite the existing data.', 'shortpixel-upscale-image'); ?>
        ...
        <content>
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Generate image ALT tag', 'shortpixel-upscale-image'),
        ...
        <content>
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Generate image description', 'shortpixel-upscale-image'),
        ...
        <content>
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Generate image caption', 'shortpixel-upscale-image'),
        ...
        <content>
          ...
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Update image title with an SEO-friendly one', 'shortpixel-upscale-image'),
        ...
        <content>
          ...
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Update image filename with an SEO-friendly one', 'shortpixel-upscale-image'),
        ...
        <content class='nextline ai_gen_filename is-advanced'>
          <?php $this->printSwitchButton(
            [
              ...
              'label' => esc_html__('Prefer keeping current filename if relevant', 'shortpixel-upscale-image'),
              'disabled' => true
            ]
          );
          ?>
  ...
  <!-- will add this later
    <setting class='switch'>
        ...
        <content>
        <name><?php // _e('Use image EXIF data', 'shortpixel-upscale-image'); 
              ?></name>
        <?php $this->printSwitchButton(
          [
            'name' => 'ai_use_exif',
            'checked' => $view->data->ai_use_exif,
            'label' => esc_html__('Take into account the image EXIF data when generating image SEO data', 'shortpixel-upscale-image')
          ]
        );
        ?>
        </content>
      ...
      <content>
        <?php $this->printSwitchButton(
          [
            ...
            'label' => esc_html__('Use parent Post / Page title for image SEO data', 'shortpixel-upscale-image')
          ]
        );
        ?>
