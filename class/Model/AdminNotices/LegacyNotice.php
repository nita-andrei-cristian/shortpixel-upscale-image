...
class LegacyNotice extends \ShortPixel\Model\AdminNoticeModel
{
	...
	{
		$message = '<p><strong>' .  __('ShortPixel has found items in the media library with an outdated upscale format!', 'shortpixel-image-optimiser') . '</strong></p>';

		$message .= '<p>' . __('Prior to version 5.0, a different format was used to store ShortPixel upscale information. ShortPixel automatically migrates the media library items to the new format when they are opened. %s Please check if your images contain the upscale information after migration. %s Read more %s', 'shortpixel-image-optimiser') . '</p>';
		...
		$action_name = __('Migrate upscale data', 'shortpixel-image-optimiser');
