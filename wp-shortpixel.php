 ...
 * Description: ShortPixel upscales images automatically while preserving visual quality. Check your <a href="/wp-admin/options-general.php?page=shortpixel-upscale-settings" target="_blank">Settings &gt; Shortpixel Image Upscale</a> page to start upscaling your image library.
 * Version: 6.4.4
...
define('SPUI_BACKUP', 'ShortPixelUpscaleBackups');
